import {Contract, ContractData, ContractFactory, ContractItem, ContractItemFactory} from '../lib/invoicing';
...
describe('contract tests', () => {
    ...
    it('should create a contract from default values', () => {
        const contract = ContractFactory.fromData(Contract.defaultValues());
    ...
    it('should create a contract containing default values, if an empty object has been provided', () => {
        ...
        const contract = ContractFactory.fromData(data);
        expect(contract).toBeTruthy();
    ...
    describe('test getters and setters', () => {
        ...
        beforeEach(() => {
            const data = mockContract().data;
            contract = ContractFactory.fromData(data);
        });
    ...
    describe('contract item tests', () => {
        ...
        it('should create an item from data', () => {
            ...
            const item = ContractItemFactory.fromData(data);
